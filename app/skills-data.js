...
export const SKILLS_DATA = {
  domains: [
    ...
    },
    {
      ...
      skills: [
        {
          name: 'Flux — Prompt Engineering',
          slug: 'flux-prompting',
          desc: 'Write optimal prompts for Flux Pro/Dev/Schnell. Structure: subject → style → lighting → camera → quality tags.',
          useWhen: 'writing prompts for any Flux model (BFL, fal.ai, Replicate)',
          source: 'user',
          tags: ['flux', 'prompt', 'bfl', 'image'],
          triggers: ['flux prompt', 'flux pro', 'flux dev', 'flux schnell', 'bfl', 'black forest labs', 'write prompt for image', 'image prompt'],
        },
        {
          ...
          triggers: ['comfyui', 'comfy ui', 'local comfy', 'comfyui setup', 'comfyui install', 'comfyui api', 'local diffusion'],
        },
        {
          name: 'ComfyUI — Custom Node Guide',
          slug: 'comfyui-nodes',
          desc: 'Recommended node packs: ComfyUI-Manager, Impact Pack, ControlNet, IPAdapter, SDXL Turbo, AnimateDiff.',
          useWhen: 'extending ComfyUI with custom nodes or troubleshooting missing nodes',
          source: 'user',
          tags: ['comfyui', 'nodes', 'extensions', 'custom'],
          triggers: ['comfyui nodes', 'custom nodes', 'comfy nodes', 'impact pack', 'ipadapter', 'controlnet node', 'animatediff', 'comfyui manager'],
        },
        {
          name: 'ControlNet / img2img',
          slug: 'controlnet-img2img',
          desc: 'Use ControlNet for depth, canny, pose, and scribble conditioning. img2img for image-to-image variations.',
          useWhen: 'conditioning generation on an existing image or structure',
          source: 'user',
          tags: ['controlnet', 'img2img', 'conditioning', 'depth'],
          triggers: ['controlnet', 'img2img', 'image to image', 'depth map', 'pose conditioning', 'canny edge', 'scribble', 'inpaint', 'outpaint'],
        },
        {
          name: 'Style Presets & Artists',
          slug: 'image-styles',
          desc: 'Curated style trigger words: photorealistic, cinematic, Studio Ghibli, Art Nouveau, Bauhaus, cyberpunk, etc.',
          useWhen: 'picking an art style or replicating a visual aesthetic',
          source: 'user',
          tags: ['style', 'aesthetic', 'artists', 'presets'],
          triggers: ['art style', 'image style', 'aesthetic', 'photorealistic', 'cinematic look', 'painting style', 'artist style', 'illustration style', 'anime style'],
        },
        {
          name: 'Upscaling & Enhancement',
          slug: 'image-upscale',
          desc: 'Upscale with RealESRGAN, Topaz, or ComfyUI Ultimate SD Upscale. Fix faces with GFPGAN / CodeFormer.',
          useWhen: 'increasing image resolution or fixing faces/details in generated images',
          source: 'user',
          tags: ['upscale', 'enhance', 'resolution', 'realesrgan'],
          triggers: ['upscale', 'upscaling', 'increase resolution', 'fix face', 'sharpen image', 'realesrgan', 'topaz', 'hires fix', 'ultimate upscale'],
        },
        {
          name: 'Aspect Ratio & Sizing',
          slug: 'image-sizing',
          desc: 'Optimal dimensions per model: Flux (1024×1024, 1792×1024, 1024×1440), SDXL (1024×1024), SD1.5 (512×512).',
          useWhen: 'choosing dimensions for image generation',
          source: 'user',
          tags: ['aspect ratio', 'dimensions', 'size', 'resolution'],
          triggers: ['aspect ratio', 'image size', 'dimensions', 'portrait', 'landscape', 'square image', 'wide image', 'tall image', '16:9', '9:16'],
        },
        {
          name: 'Batch Generation & Variations',
          slug: 'image-batch',
          desc: 'Generate multiple variations: seed sweeps, CFG scale experiments, prompt variations. ComfyUI queue vs single-run.',
          useWhen: 'generating multiple images or comparing variants',
          source: 'user',
          tags: ['batch', 'variations', 'seed', 'cfg'],
          triggers: ['batch images', 'multiple images', 'image variations', 'seed variation', 'cfg scale', 'sampling steps', 'generate multiple', 'compare images'],
        },
        {
          name: 'Negative Prompts',
          slug: 'negative-prompts',
          desc: 'Effective negatives for Flux/SD: ugly, deformed, blurry, watermark, text, extra limbs, low quality patterns.',
          useWhen: 'reducing artifacts or unwanted elements in generated images',
          source: 'user',
          tags: ['negative prompt', 'artifacts', 'quality', 'fix'],
          triggers: ['negative prompt', 'avoid', 'remove from image', 'no watermark', 'fix artifacts', 'deformed', 'ugly output', 'bad quality'],
        },
        {
          name: 'Flux vs ComfyUI — When to Use',
          slug: 'flux-vs-comfyui',
          desc: 'Decision guide: Flux API (BFL/fal) for quality/speed; ComfyUI for control/custom nodes/offline/no cost.',
          useWhen: 'deciding which image backend to use',
          source: 'user',
          tags: ['flux', 'comfyui', 'comparison', 'decision'],
          triggers: ['flux or comfyui', 'which provider', 'comfyui vs flux', 'local vs cloud image', 'best image model', 'image provider comparison'],
        },
      ]
    },
  ],
