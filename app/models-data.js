...
export const MODELS_DATA = {
  ...
  models: [
    ...
    {
      id: 'kling-video-v3-fal',
      provider: 'image-gen',
      imageProvider: 'fal',
      imageModel: 'fal-ai/kling-video/v3/turbo/pro/image-to-video',
      name: 'Kling v3 Turbo Pro (fal.ai)',
      shortName: 'Kling v3 (fal)',
      tier: 'image',
      contextK: 0,
      inputPer1M: 0,
      outputPer1M: 0,
      supportsThinking: false,
      toolCalling: false,
      desc: 'Kling v3 Turbo Pro Image-to-Video via fal.ai.',
      badge: 'fal',
    },
    {
      id: 'sync-lipsync-v3-fal',
      provider: 'image-gen',
      imageProvider: 'fal',
      imageModel: 'fal-ai/sync-lipsync/v3/image-to-video',
      name: 'Sync Lipsync v3 (fal.ai)',
      shortName: 'Lipsync v3 (fal)',
      tier: 'image',
      contextK: 0,
      inputPer1M: 0,
      outputPer1M: 0,
      supportsThinking: false,
      toolCalling: false,
      desc: 'Sync Lipsync v3 Image-to-Video via fal.ai.',
      badge: 'fal',
    },
    {
      id: 'grok-video-fal',
      provider: 'image-gen',
      imageProvider: 'fal',
      imageModel: 'xai/grok-imagine-video/v1.5/image-to-video',
      name: 'Grok 1.5 Video (fal.ai)',
      shortName: 'Grok Video (fal)',
      tier: 'image',
      contextK: 0,
      inputPer1M: 0,
      outputPer1M: 0,
      supportsThinking: false,
      toolCalling: false,
      desc: 'xAI Grok 1.5 Image-to-Video via fal.ai.',
      badge: 'fal',
    },
    {
      id: 'kling-2.5-novita',
