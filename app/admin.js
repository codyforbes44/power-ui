...
python3 cli.py export --format json</pre>
  ...
  const PROVIDER_DEFS = [
    ...
    { id: 'groq',      name: 'Groq',        icon: '⚡',  color: '#f55036', placeholder: 'gsk_…',           baseUrl: 'https://api.groq.com',                       docsUrl: 'https://console.groq.com/keys',              testPath: '/v1/models',          testHeaders: (k) => ({ 'Authorization': `Bearer ${k}` }) },
